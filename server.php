...
function insert_new_user($fname, $lname, $email, $password)
{	
    $query = "INSERT INTO users (fname, lname, email, password, created_at) VALUES ('{$fname}','{$lname}','{$email}','{$password}',NOW())";
